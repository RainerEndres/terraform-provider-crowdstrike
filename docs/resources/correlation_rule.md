...
- `config_id` (String) The configuration ID for the notification.
- `plugin_id` (String) The plugin ID for the notification.
- `severity` (String) The severity level for the notification.
